    ...
    <section id="data" className="py-32 px-6 md:px-12 max-w-7xl mx-auto bg-transparent">
      <div className="mb-24 max-w-4xl mx-auto text-center">
        <p className="text-lg md:text-xl text-brand-text/80 font-sans leading-relaxed">
          為了進一步調查當代年輕人與 AI 建立情感連結的真實動機、心理依賴程度以及潛在的社交影響。我們發起了一項關於AI 時代下年輕人群體人機交互與情感補償的專項問卷調查。本次問卷聚焦於受訪者對 AI 的定義、日常非功能性交互、服務中斷時的心理變化，以及對 AI 倫理風險的感知等多個維度。我們主要在各大社交媒體平台、年輕人活躍的網絡社區和大學社群等發佈線上問卷，同時也在香港浸會大學賽馬會食堂、李作權大道休息區、教學及行政大樓的五樓食堂以及善衡校區食堂進行線下隨機紙質問卷發放。最終，我們成功回收了 205 份有效問卷。
        </p>
      </div>
      ...
      <div className="mt-32 text-center max-w-4xl mx-auto">
        <p className="text-lg md:text-xl text-brand-text/80 font-sans leading-relaxed">
          在對 205 份問卷進行量化分析之後，為了更深層次的探索人機關係中更隱蔽且更具溫度的部分，三位具有代表性的受訪者受邀參與了一對一的深度訪談。在這些對話中，訪談圍繞著他們截然不同的三個使用目的與層面展開，從尋求零壓力的社交環境，到建立理想化的人機關係，再到把其視為獲取社交媒體流量的工具。這些個案揭示了她們複雜而真實的內心世界。
        </p>
      </div>
    </section>
  );
